...
with read_base():
    from ...maptracker.rdx_dataset.maptracker_rdx_stage2_warmup import *

# Teacher/student settings ----------------------------------------------------
model = dict(
    _delete_=True,
    type='MapTrackerDistiller',
    student_cfg='plugin/configs/maptracker/rdx_dataset/maptracker_rdx_stage2_warmup.py',
    student_pretrained='work_dirs/maptracker_rdx_stage1_bev_pretrain_kd/latest.pth',
    teacher_cfgs=[
        dict(
            config='plugin/configs/maptracker_aerial_fuse/rdx_dataset/'
                   'maptracker_rdx_stage2_warmup_aerial_fuse.py',
            checkpoint='work_dirs/teacher_checkpoints/rdx_stage_2.pth',
            weight=1.0,
            name='aerial_teacher',
        ),
    ],
    ...
    head_kd_weight=12,
    head_cls_weight=1.0,
    head_point_weight=1.0,
    head_attr_weight=0.3,
    head_attr_temperature=2.0,
)
