...
load_from = "work_dirs/maptracker_rdx_stage1_bev_pretrain_aerial_fuse/latest.pth"
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='maptracker_RDX_aerial_fuse_stage2',
            tags=['stage_2', 'aerial_fuse']),
            #entity='honda-sv'
        define_metric_cfg=[
