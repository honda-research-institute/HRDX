    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs={
                ...
                'name': 'maptracker_nusc_newsplit_5frame_span10_stage2_warmup_lidar_fuse',   # ✅ set a run name
...
load_from = "work_dirs/maptracker_nusc_newsplit_lidar_fuse_5frame_span10_stage1_bev_pretrain/latest.pth"
