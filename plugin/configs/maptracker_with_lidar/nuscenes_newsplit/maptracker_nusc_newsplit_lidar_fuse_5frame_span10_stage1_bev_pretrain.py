...
model = dict(
    ...
    # LiDAR->BEV fusion defaults (disabled)
    lidar_bev_cfg=dict(
        enabled=True,
    ...
    fusion_bev_cfg=dict(
        enabled=True,
        type='FusionBEV',
        # in_channels/out_channels inferred automatically
    ),
    backbone_cfg=dict(
...
train_pipeline = [
    ...
    dict(type='LoadLidarPointsFromFile', file_key='lidar_filename', load_dim=5, use_dim=(0, 1, 2, 3),filter_roi=((-roi_size[0]/2,roi_size[0]/2),(-roi_size[1]/2,roi_size[1]/2),(-20,20))),
...
match_config = dict(
    ...
    pipeline=[
        ...
        dict(type='LoadLidarPointsFromFile', file_key='lidar_filename', load_dim=5, use_dim=(0, 1, 2, 3),filter_roi=((-roi_size[0]/2,roi_size[0]/2),(-roi_size[1]/2,roi_size[1]/2),(-20,20))),
        dict(type='FormatBundleMap'),
        dict(type='Collect3D', keys=['vectors', 'semantic_mask','points'], meta_keys=['token', 'ego2img', 'ego2cam', 'sample_idx', 'ego2global_translation',
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs={
                ...
                'name': 'maptracker__nusc_newsplit_5frame_span10_stage1_bev_pretrain_lidar_fuse',   # ✅ set a run name
