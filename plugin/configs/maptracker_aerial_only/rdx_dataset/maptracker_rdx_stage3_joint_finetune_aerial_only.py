...
# optimizer – joint finetune; aerial encoder at reduced LR, camera backbone frozen
# LR scaled by sqrt(4)=2x from 2e-4 due to larger effective batch
optimizer = dict(
    type='AdamW',
    lr=4e-4,
    paramwise_cfg=dict(
...
load_from = "work_dirs/maptracker_rdx_stage2_warmup_aerial_only/latest.pth"
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='maptracker_RDX_aerial_only_stage3',
            tags=['stage_3', 'aerial_only']),
        define_metric_cfg=[
