...
try:  # pragma: no cover - optional dependency in mmcv>=2.0
    from mmcv import jit  # type: ignore
except Exception:  # pragma: no cover - fallback when mmcv.jit missing
    from plugin.utils.mmcv_compat import jit
